            ...
            <div class="row ">
                <div class="col-xl-2 col-lg-2 col-md-2">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{ url('/') }}">
                        <img class="main__logo--img" src="{{asset('assets/image/ihouseblack.jpg')}}" alt="logo-img" >
                    </a></h1>
                </div>
                <div class="col-xl-4 col-lg-5 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title about">Մեր մասին <button class="footer__widget--button"
                        ...
                        <div class="footer__widget--inner">
                            ...
                            <ul class="footer__widget--info">
                                ...
                                <li class="footer__widget--info_list">
                                    ...
                                    <a class="footer__widget--info__text" href="tel:+37433614010">: +374 (33)
                                        61-40-10</a>
                                ...
                                <li class="footer__widget--info_list">
                                    ...
                                    <a class="footer__widget--info__text" href="tel:+37498614010">: +374 (98)
                                        61-40-10</a>
                ...
                <div class="col-xl-4 col-lg-3 col-md-3">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Ծառայություններ <button class="footer__widget--button"
                                aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="{{ url('/') }}"> Գլխավոր էջ </a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="./listing.html">Գործընկերներ</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="./listing.html">Նորություններ</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="{{route('aboute')}}">Մեր Մասին</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="{{route('email')}}">Հետադարց կապ</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-lg-5 col-md-6">
                    <div class="footer__widget">
                        <h2 class="footer__widget--title ">Հետևեք մեզ <button class="footer__widget--button"
                                aria-label="footer widget button"></button>
                            <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg"
                                width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z"
    ...
    <div class="footer__bottom color-offwhite">
        <div class="container">
            <div class="footer__bottom--inner d-flex justify-content-between align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary">© 2024</span> Powered By <a
