    ...
    <div class="container-fluid px-4">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/update-land/' . $land->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="name1">Տեսակ</label>
                        <input type="text" name="name1" class="form-control"
                            value="{{ old('name1', $land->name1 ?? '') }}">
                    </div>

                    <div class="mb-3">
                        <label for="name2">Հողատարածքի մակերես</label>
                        <input type="text" name="name2" class="form-control"
                            value="{{ old('name2', $land->name2 ?? '') }}">
                    </div>

                    <div class="mb-3">
                        <label for="name3">Կոմունիկացիաներ</label>
                        <input type="text" name="name3" class="form-control"
                            value="{{ old('name3', $land->name3 ?? '') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" class="form-control"
                            value="{{ old('slug', $land->slug ?? '') }}">
                    </div>


                    <div class="mb-3">
                        <label for="description">կոդ</label>
                        <textarea name="description" class="form-control">{{ old('description', $land->description ?? '') }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="image">Image</label>
                        <input type="file" name="image" class="form-control">
                        @if (isset($land) && $land->image)
                            <img src="{{ asset('uploads/category/' . $land->image) }}" width="100" height="100"
                                alt="Category Image">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <textarea rows="3" name="meta_keywords" class="form-control">{{ old('meta_keywords', $land->meta_keywords ?? '') }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="meta_title">Գործակալի Հեռ․՝</label>
                        <input type="text" name="meta_title" class="form-control"
                            value="{{ old('meta_title', $land->meta_title ?? '') }}">
                    </div>
                    <div class="mb-3">
                        <label for="slug1">Գործակալի Հեռ․՝ Soc Hub</label>
                        <input type="text" name="slug1" value="{{$land->slug1}}" class="form-control">
                    </div>

                    @php
                        $decodedImages = json_decode($land->image1, true);
                    ...
                    <div class="mb-3">
                        ...
                        @if ($land)
                            ...
                            @if (!empty($land->image1) && json_decode($land->image1, true))
                                @foreach (json_decode($land->image1, true) as $image)
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea rows="3" name="des" class="form-control">{{ $land->des }}</textarea>
                        </div>
