        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin/categ', $categs->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @foreach ([
                        'name101' => 'Փողոց',
                        'name102' => 'Շինության տիպ',
                        'name103' => 'Նորակառույց',
                        'name104' => 'Վերելակ',
                        'name105' => 'Հարկերի քանակ',
                        'name106' => 'Կայանատեղի',
                        'name107' => 'Ընդհանուր մակերես',
                        'name108' => 'Սենյակների քանակ',
                        'name109' => 'Սանհանգույցների քանակ',
                        'name110' => 'Առաստաղի բարձրություն',
                        'name111' => 'Հարկ',
                        'name112' => 'Պատշգամբ',
                        'name113' => 'Կահույք',
                        'name114' => 'Վերանորոգում',
                        'name115' => 'Հարմարություններ',
                        'name116' => 'Կենցաղային տեխնիկա',
                        'name117' => 'Տեսարան պատուհանից',
                        'name118' => 'Գին',
                        'name119' => 'Կոդ'
                    ] as $name => $label)
                        <div class="mb-3">
