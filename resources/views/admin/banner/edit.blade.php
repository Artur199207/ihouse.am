    ...
    <div class="container-fluid px-4">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/update-banner/' . $banner->id) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @if (isset($banner) && $banner->image)
                            <img src="{{ asset('uploads/category/' . $banner->image) }}" width="100" height="100"
                                alt="Category Image">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <textarea rows="3" name="meta_keywords" class="form-control">{{ old('meta_keywords', $banner->meta_keywords ?? '') }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="meta_title">Գործակալի Հեռ․՝</label>
                        <input type="text" name="meta_title" class="form-control"
                            value="{{ old('meta_title', $banner->meta_title ?? '') }}">
                    </div>
                    <div class="mb-3">
                        <label for="slug1">Գործակալի Հեռ․՝ Soc Hub</label>
                        <input type="text" name="slug1" value="{{$banner->slug1}}" class="form-control">
                    </div>

                    @php
                        $decodedImages = json_decode($banner->image1, true);
                    ...
                    <div class="mb-3">
                        ...
                        @if ($banner)
                            ...
                            @if (!empty($banner->image1) && json_decode($banner->image1, true))
                                @foreach (json_decode($banner->image1, true) as $image)
                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea rows="3" name="des" class="form-control">{{ $banner->des }}</textarea>
                        </div>
