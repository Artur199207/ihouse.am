          ...
          <div class="listing__widget">
            ...
            <div class="admin__profile--thumbnail">
              ...
              <div class="admin__profile--content">
                <h3 class="admin__profile--name">  {{ $category->meta_keywords }}</h3>
                
              <p>Հեռ․՝
              <a  href="tel:{{ $category->meta_title }}">{{ $category->meta_title }}</a>
              </p>
                ...
                <ul class=" profile__social d-flex align-items-center justify-content-center">
                  ...
                  <li class="profile__social--list">
                    <a class="profile__social--icon" target="_blank" href="tel:{{ $category->meta_title }}">
...
<path style="fill:#FFA1AC;" d="M43.71,28.999c-0.073,0-0.147-0.008-0.222-0.024c-0.539-0.122-0.876-0.657-0.755-1.196
  ...
  <ul class="dropdown-menu">
                                ...
                                <p>Հեռ․՝
                                    <a href="tel:{{ $category->name18 }}">{{ $category->name18 }}</a>
                                </p>
                                <p>Telegram: 
                                    <a href="https://t.me/{{ $category->name18 }}" target="_blank"> {{ $category->name18 }}</a>
                                </p>
                                <p>WhatsApp: 
    <a href="https://wa.me/{{ $category->name18 }}" target="_blank">
    {{ $category->name18 }}
    </a>
</p>
                                <p>Viber: 
                                    <a href="viber://chat?number={{ $category->name18 }}" target="_blank"> {{ $category->name18 }}</a>
                                </p>
                        ...
                        <div class="listing__details--wrapper">
                                ...
                                <div class="listing__details--content__step">
                                    ...
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">{{ $category->slug}}</span>
                                         
                                        </div>
                                        <span class="listing__details--property__id">Կոդ : {{ $category->description}}</span>
                                    </div>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--count">{{ $category->name8}}</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--count">{{ $category->name6}}</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    <span class="apartment__info--count">{{ $category->name7}}</span>
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">{{ $category->name2}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Նորակառույց:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name3}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Վերելակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name4}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Հարկերի քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name5}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կայանատեղի:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name6}}</span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">{{ $category->name7}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Սենյակների քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name8}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Սանհանգույցների քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name9}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Առաստաղի բարձրություն:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name10}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Հարկ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name11}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Պատշգամբ:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name12}}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կահույք:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name13}}</span>
                                        </li>
                                         <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Վերանորոգում:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name14}}</span>
                                        </li>
                                         <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կենցաղային տեխնիկա:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name16}}</span>
                                        </li>
                                         <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Տեսարաններ պատուհաններից:</span>
                                            <span class="properties__details--info__subtitle">{{ $category->name17}}</span>
                                        </li>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <p class="listing__details--content__desc">{{ $category->des}}</p>
                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                               ...
                                               <iframe 
    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAWM0XzxujknxaImMPST8aZLwrgLa973pE&q={{ urlencode($category->name) }}" 
    allowfullscreen 
    loading="lazy" 
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="{{ asset('public/uploads/category/' . $category->image) }}" alt="img">
                                        <div class="featured__badge">
                                            <span class="badge__field">{{ $category->description}}</span>
                                        </div>
                                    </div>
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">{{ $category->slug}}</span>
