  ...
  @endphp
    ...
    <div id="owl-example" class="owl-carousel">
      <div class="properties">
        <div class="image-holder"><img src="{{asset('assets/images/properties/1.jpg')}}" class="img-responsive"
            alt="properties" />
    ...
    @endforeach
      ...
      <div class="properties">
        <div class="image-holder"><img src="{{asset('assets/images/properties/2.jpg')}}" class="img-responsive"
            alt="properties" />
      ...
      <div class="properties">
        <div class="image-holder"><img src="{{asset('assets/images/properties/4.jpg')}}" class="img-responsive"
            alt="properties" /></div>
        <h4><a href="property-detail.php">Royal Inn</a></h4>
        <p class="price">Price: $234,900</p>
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom"
      ...
      <div class="properties">
        <div class="image-holder"><img src="{{asset('assets/images/properties/3.jpg')}}" class="img-responsive"
            alt="properties" />
          <div class="status new">New</div>
        </div>
        <h4><a href="property-detail.php">Royal Inn</a></h4>
        ...
        <div id="myCarousel" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="row">
                <div class="col-lg-4"><img src="{{asset('assets/images/properties/1.jpg')}}" class="img-responsive"
                    alt="properties" /></div>
                <div class="col-lg-8">
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="{{asset('assets/images/properties/2.jpg')}}" class="img-responsive"
                    alt="properties" /></div>
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="{{asset('assets/images/properties/3.jpg')}}" class="img-responsive"
                    alt="properties" /></div>
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="{{asset('assets/images/properties/4.jpg')}}" class="img-responsive"
                    alt="properties" /></div>
                <div class="col-lg-8">
                  <h5><a href="property-detail.php">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
