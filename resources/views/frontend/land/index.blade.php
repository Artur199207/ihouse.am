                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                        <div id="mySlider" class="pandapp-slider">
                            <div class="pandapp-wrapper">
                                @if (!empty($land->image1))
                                    @php
                                        $images = json_decode($land->image1, true);
                                    @endphp
                        ...
                        <div class="listing__widget">
                            <div class="widget__admin--profile text-center mb-30">
                                ...
                                <div class="admin__profile--content">
                                    <h3 class="admin__profile--name"> {{ $land->meta_keywords }}</h3>

                                    <p>Հեռ․՝
                                        <a href="tel:{{ $land->meta_title }}">{{ $land->meta_title }}</a>
                                    </p>
                            ...
                            <div class="content-rigth">
                                <div class="btn-group dropup">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <p>Հեռ․՝
                                            <a href="tel:{{ $land->name18 }}">{{ $land->name18 }}</a>
                                        </p>
                                        <p>Telegram:
                                            <a href="https://t.me/{{ $land->name18 }}" target="_blank">
                                                {{ $land->name18 }}</a>
                                        </p>
                                        <p>WhatsApp:
                                            <a href="https://wa.me/{{ $land->name18 }}" target="_blank">
                                                {{ $land->name18 }}
                                            </a>
                                        </p>
                                        <p>Viber:
                                            <a href="viber://chat?number={{ $land->name18 }}" target="_blank">
                                                {{ $land->name18 }}</a>
                                        </p>
                        ...
                        <div class="listing__details--wrapper">
                                ...
                                <div class="listing__details--content__step">
                                    ...
                                    <div class="listing__details--price__id d-flex align-items-center">
                                        <div class="listing__details--price d-flex">
                                            <span class="listing__details--price__new">{{ $land->slug }}</span>

                                        </div>
                                        <span class="listing__details--property__id">Կոդ : {{ $land->description }}</span>
                                    </div>
                            ...
                            <div class="listing__details--main__content">
                                <div class="listing__details--content__step mb-80">
                                        ...
                                        <div class="apartment__info--wrapper d-flex">
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--count">{{ $land->name8 }}</span>
                                            ...
                                            <div class="apartment__info--list">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="apartment__info--count">{{ $land->name6 }}</span>
                                            ...
                                            <div class="apartment__info--list">
                                                <span class="apartment__info--icon"><img
                                                        ...
                                                        alt="img"></span>
                                                <p>
                                                    <span class="apartment__info--count">{{ $land->name7 }}</span>
                                    ...
                                    <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">{{ $land->name1 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Հողատարածքի մակերեսը:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name2 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կոմունիկացիաներ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name3 }}</span>
                                        </li>
                                        {{-- <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Հարկերի քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name5 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կայանատեղի:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name6 }}</span>
                                        </li> --}}
                                    </ul>
                                    ...
                                    {{-- <ul class="properties__details--info__wrapper d-flex">
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            ...
                                            <span class="properties__details--info__subtitle">{{ $land->name7 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Սենյակների քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name8 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Սանհանգույցների քանակ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name9 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Առաստաղի բարձրություն:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name10 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Հարկ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name11 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Պատշգամբ:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name12 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կահույք:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name13 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Վերանորոգում:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name14 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Կենցաղային տեխնիկա:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name16 }}</span>
                                        </li>
                                        <li class="properties__details--info__list d-flex justify-content-between">
                                            <span class="properties__details--info__title">Տեսարաններ պատուհաններից:</span>
                                            <span class="properties__details--info__subtitle">{{ $land->name17 }}</span>
                                        </li>
                                ...
                                <div class="listing__details--content__step properties__info mb-80">
                                    ...
                                    <p class="listing__details--content__desc">{{ $land->des }}</p>
                                </div>
                                    ...
                                    <div class="listing__details--location__header d-flex justify-content-between mb-40">
                                        ...
                                        <div class="location__google--maps">
                                            <details>
                                                ...
                                                <iframe
                                                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAWM0XzxujknxaImMPST8aZLwrgLa973pE&q={{ urlencode($land->name) }}"
                            ...
                            <div class="widget__step mb-30">
                                ...
                                <div class="widget__featured--properties">
                                    <div class="widget__featured--properties__thumbnail position-relative">
                                        <img src="{{ asset('public/uploads/category/' . $land->image) }}" alt="img">
                                        <div class="featured__badge">
                                            <span class="badge__field">{{ $land->description }}</span>
                                        </div>
                                    </div>
                                    <div class="widget__featured--properties__content">
                                        ...
                                        <div class="widget__featured--propertie__price d-flex">
                                            <span class="new__price">{{ $land->slug }}</span>
                            ...
                            {{-- <div class="widget__step">
                                ...
                                <div class="widget__featured">
                                    <div class="widget__featured--items d-flex">
                                        @php
                                            $exclusive = App\Models\Exclusive::get();
                                        @endphp
                                        <div class="widget__featured">
                                            @foreach ($land->take(3) as $category)
                                                <div class="widget__featured--items d-flex">
